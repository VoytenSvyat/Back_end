...
Это модель документа, у него есть список связанных документов List<Document> relatedDocs По бизнес условиям для
редактирования документа необходимо получить эксклюзивный доступ ко всем связанным документам.
